                ...
                <Accordion>
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                            ...
                            <p>HTTP define un set de significativos códigos de status que pueden ser devueltos por la API. Éstos pueden ser
                                nivelados para ayudar a los consumidores de la API dirigir sus
                                respuestas de forma apropiada. <br />
                                De forma genérica los códigos HTTP que comienzan por los números indicados abajo, tienen el siguiente
                                significado:<br />
                                +--------------------------------------------------------------+

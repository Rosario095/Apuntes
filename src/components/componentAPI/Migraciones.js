                ...
                <Accordion>
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                            ...
                            +--------------------------------------------------------+
                            <br />
                            <p>ATENCIÓN: si hemos creado las plantillas de Modelo sin usar PHP Artisan, entonces borrarremos todas las
                                migrations que aparecen por defecto en la carpeta <b><i>database/migrations</i></b>.<br />
                                Crearemos las plantillas de migraciones, teniendo en cuenta la conexión existente entre las tablas, así que,
                                siguiendo los ejemplos que hemos ido llevando, crearemos primero "fabricantes" y luego crearemos "aviones".</p>
                            ...
                            <p>Se crearian y almacenarían en el directorio <b><i>database/migrations/</i></b>, cuyo nombre
                                sería <b>xxxx_nombretabla:migrations.php</b>, donde "xxxx" sería la fecha y hora de el momento de creación. <br />
                                Ahora pasariamos a editar el fichero creado, indicando tipos de cambos, etc... sigamos usando como referencia el
                                ejemplo que hemos ido llevando (usaremos el de aviones que sería el más completo con respento a lo que podríamos
                                configurar):</p>
                            <Accordion>
                                <Accordion.Item eventKey="0">

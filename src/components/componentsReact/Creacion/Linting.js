                ...
                <Accordion>
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                            ...
                            <p>1) Install ESLint globally
                                <br />+----------------------+
                                <br /><i>npm install -g eslint</i>
                                <br />+----------------------+
                            </p>
                            <p>2) Init ESLint in the project
                                <br />+--------------+
                                <br /><i>eslint --init</i>
                                <br />+--------------+
                            </p>
                            <p>3) Add a lint script in package.json</p>
                            <img src={lint} alt="code" />
                            <br />
                            <p>4) Adjust .eslint.json with this optional recommendation</p>
